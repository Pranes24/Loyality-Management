# Claude Rules — Loyalty Management Project
...
| 8 | Postman Collection | Update loyalty-api.postman_collection.json for every new endpoint |
| 10 | Database | PostgreSQL only — no SQLite. Use `pg` (node-postgres) library. Migrations via SQL files in db/migrations/ |
